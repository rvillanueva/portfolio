...
class Particle {
  ...
  draw = (p5: p5Types, offsetY: number) => {
...
class Scene {
  particles: Particle[] = [];
  addParticle(x: number, y: number, r: number, p5: p5Types) {
    this.particles.push(new Particle(x, y, r, p5));
  }
  clearParticles(height: number) {
  ...
  run = (p5: p5Types, offsetY: number, height: number) => {
